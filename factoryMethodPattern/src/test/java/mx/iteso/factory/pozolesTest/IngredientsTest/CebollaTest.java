...
import mx.iteso.factory.pozoles.Ingredients.Cebolla;
...
public class CebollaTest {
    ...
    public void IngredientTest(){
        ...
        PozoleIngedient ingedient = new Cebolla(menudo);
        assertEquals("Menudo de Caldo Rojo con Cebolla",ingedient.getName());
    }
}
