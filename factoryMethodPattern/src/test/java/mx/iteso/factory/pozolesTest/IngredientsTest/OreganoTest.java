...
import mx.iteso.factory.pozoles.Ingredients.Oregano;
...
public class OreganoTest {
    ...
    public void IngredientTest(){
        ...
        PozoleIngedient ingedient = new Oregano(menudo);
        assertEquals("Menudo de Caldo Rojo con Oregano",ingedient.getName());
    }
}
