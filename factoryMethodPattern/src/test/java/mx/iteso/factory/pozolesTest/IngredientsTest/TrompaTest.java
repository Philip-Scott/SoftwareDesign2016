...
import mx.iteso.factory.pozoles.Ingredients.Trompa;
 ...
 */
public class TrompaTest {
    @Test
    public void IngredientTest(){
        Pozole menudo = new Menudo();
        PozoleIngedient ingedient = new Trompa(menudo);
        assertEquals("Menudo de Caldo Rojo con Trompa",ingedient.getName());
    }
}
